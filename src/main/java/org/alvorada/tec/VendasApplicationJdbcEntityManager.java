...
import org.alvorada.tec.domain.repository.ClientesEntityManager;
...
public class VendasApplicationJdbcEntityManager {
    ...
    public CommandLineRunner initJdbcEntityManager(@Autowired ClientesEntityManager clientes) { // Aqui estou injetando a minha classe Clientes (de repository)
        return args -> {
            /* Mais verboso...
    ...
    public static void main(String[] args) {
        SpringApplication.run(VendasApplicationJdbcEntityManager.class, args);
    }
}
